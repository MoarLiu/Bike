...
- 支持 `BIKE_MCP_MODE=write` 或配置文件 `mode: "write"` 显式启用真实写入。
...
- Electron macOS Apple Silicon: `Bike-1.3.0-arm64.dmg`
- 本次产物仍使用 ad-hoc/未正式签名构建，尚未 notarize；适合个人安装测试。公开分发前建议接入 Apple Developer ID 签名和 notarization。

## SHA-256

- `Bike-1.3.0-arm64.dmg`: `5dbe0df77bbe2a221214bc99be24c7ee1c1a5be52bab030d143f7943ce1e5663`
- `Bike-1.3.0-arm64.dmg.blockmap`: `4cb5f56b1fb42ea18f44f20287450ecbb8a9604abe85a71a5d489b7c3a80f774`

## 关联文档

- [Bike MCP 服务需求说明](./mcp-service-requirements.md)
- [Bike 1.2.0 更新说明](./release-1.2.0.md)
