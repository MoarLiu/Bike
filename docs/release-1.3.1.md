...
- 单次新增节点数量会复用 `LOCAL_OUTLINE_MCP_MAX_DOCUMENT_NODES` / `maxDocumentNodes` 上限。
...
- `node --check mcp/localoutline-core.test.mjs`
- `git diff --check`
- `npm run build`

## 打包说明

- Electron macOS Apple Silicon: `Local Outline-1.3.1-arm64.dmg`
- 本次产物仍使用 ad-hoc/未正式签名构建，尚未 notarize；适合个人安装测试。公开分发前建议接入 Apple Developer ID 签名和 notarization。

## SHA-256

- `Local Outline-1.3.1-arm64.dmg`: `667f0c77ddb6ec75f8c4f67ff56e11a98289e73a2cfeb84aeafe1d9c827edc5b`
- `Local Outline-1.3.1-arm64.dmg.blockmap`: `7e4fc023df5fbca70d50e10e96f956d1dfd325737bb3bc360656ed9c28b4cb8b`

## 关联文档

- [Local Outline 1.3.0 更新说明](./release-1.3.0.md)
